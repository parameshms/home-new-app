...
const InRoomDinningItems = (props) => {
    ...
    <>
      <div className="flex flex-col">
        <div className="flex gap-2 text-[16px] font-semibold items-start w-52 text-wrap">
          ...
          <span>{props?.items?.itemName}</span>
        </div>
      ...
      <div className="flex flex-col items-center relative">
        ...
        {addItem === 0 ? (
          <div
            className="flex items-center justify-center p-1 w-20 border shadow-md rounded-md absolute top-16 bg-white text-[14px] font-semibold text-[#3D6464]"
            onClick={() => handleAddItem()}
          >
            ADD
          </div>
        ) : (
          <div className="flex justify-between items-center text-[14px] p-1 px-2 w-20 border shadow-md rounded-md absolute top-16 bg-white font-semibold text-[#3D6464]">
...
export default InRoomDinningItems;
